...
class SecondPage:
    def __init__(self, manage_page):
        ...
        manage_page.title("AutoShop Management System")
        ...
        class Manage:
            def __init__(self, Manage_window):
                ...
                # Manage parts Label
                manageParts = Label(coverFrame2, text='MANAGE', font=("yu gothic ui", 13, "bold"), bg='#ffffff',
                                     fg='#ff6c38')
                manageParts.place(x=80, y=0)
                ...
                partsImg = Label(coverFrame2, image=photo, bg='#ffffff')
                partsImg.image = photo
                partsImg.place(x=100, y=35)
