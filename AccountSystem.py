...
class AccountPage:
    def __init__(self, AccountSystem_window):
        ...
        AccountSystem_window.title('AUTO SHOP')
        ...
        brand_name = Label(landing_page, text='AVTO EHTIYOT QISMLAR DOKONI', bg='#ffffff', fg='#ff6c38', font=("yu gothic ui", 11, "bold"))
        brand_name.place(x=83, y=53)

        text = Label(landing_page, text="APPROVED", bg='#ffffff', font=("", 12, "bold"))
        text.place(x=20, y=140)
        txt = "• Biz barcha standartlarga mos avto ehtiyot \n  qismlari sotamiz \t\t\t \n\n• Juda arzon va tumandagi eng sifatli  " \
              "dokon \nsonggi 5 yil davomida\t"
        text2 = Label(landing_page, text=txt,
                      fg="#6b6a69", bg='#ffffff', font=("", 11, "bold"))
        text2.place(x=15, y=180)

        # ====== LOGO ==========
        partsImage = Image.open('images\\auto3.gif')
        photo = ImageTk.PhotoImage(partsImage)
        parts_image = Label(landing_page, image=photo, bg='#ffffff')
        parts_image.image = photo
        parts_image.place(x=30, y=370)
        ...
        # ========= RIGHT SIDE ===============
        # Label
        heading_label = Label(landing_page, text="Davom etish uchun tizimga kiring", font=("", 13, "bold"),
                              bg='#ffffff')
        heading_label.place(x=370, y=100)

        # Login Button
        login_button = Button(landing_page, text='Kirish', bg='black', font=("", 13, "bold"), bd=0,  fg='white',
                              cursor='hand2', activebackground='#fd6a36', activeforeground='white',
                              command=lambda: show_frame(sign_in))
        login_button.place(x=490, y=400)

        # Sign Up Button
        signUp_button = Button(landing_page, text='Yangi    akkaunt', bg='black', font=("", 13, "bold"), bd=0, fg='white',
                               cursor='hand2', activebackground='#fd6a36', activeforeground='white',
                               command=lambda: show_frame(sign_up))
        signUp_button.place(x=455, y=500)
        ...
        brand_name = Label(sign_in, text='AUTOSHOP', bg='#ffffff', fg='#ff6c38', font=("", 15, "bold"))
        brand_name.place(x=90, y=60)

        text = Label(sign_in, text="APPROVED", bg='#ffffff', font=("", 12, "bold"))
        text.place(x=20, y=140)

        txt2 = "• Biz barcha standartlarga mos avto ehtiyot \n  qismlari sotamiz \t\t\t \n\n• Juda arzon va tumandagi eng sifatli  " \
              "dokon \nsonggi 5 yil davomida\t"
        ...
        partsImage = Image.open('images\\auto3.gif')
        photo = ImageTk.PhotoImage(partsImage)
        parts_image = Label(sign_in, image=photo, bg='#ffffff')
        parts_image.image = photo
        parts_image.place(x=30, y=370)
        ...
        def login_all():
            # Admin
            conn1 = sqlite3.connect("./Database/AutoShop.db")
            ...
            # Guest
            conn2 = sqlite3.connect("./Database/AutoShop.db")
            ...
            # Employee
            conn3 = sqlite3.connect("./Database/AutoShop.db")
        ...
        def forgot_password():
            ...
            def change_password():
                db = sqlite3.connect("./Database/AutoShop.db")
                cur = db.cursor()
        ...
        brand_name = Label(sign_up, text='AUTOSHOP', bg='#ffffff', fg='#ff6c38', font=("", 15, "bold"))
        brand_name.place(x=90, y=60)

        text = Label(sign_up, text="APPROVED", bg='#ffffff', font=("", 12, "bold"))
        text.place(x=20, y=140)
        txt3 = "• Biz barcha standartlarga mos avto ehtiyot \n  qismlari sotamiz \t\t\t \n\n• Juda arzon va tumandagi eng sifatli  " \
              "dokon \nsonggi 5 yil davomida\t"
        ...
        partsImage = Image.open('images\\auto3.gif')
        photo = ImageTk.PhotoImage(partsImage)
        parts_image = Label(sign_up, image=photo, bg='#ffffff')
        parts_image.image = photo
        parts_image.place(x=30, y=370)
        ...
        def signup_all():
            ...
            if check_counter == 3:
                try:
                    connection = sqlite3.connect("./Database/AutoShop.db")
