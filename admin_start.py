...
class FirstPage:
    def __init__(self, dashboard_window):
        ...
        heading = Label(homepage, text='© ALIAKBAR AUTO SH0P', bg='black', fg='#ff6c38', font=("yu gothic ui", 19, "bold"))
        ...
        partsImg = Label(homepage, image=photo, bg='black')
        partsImg.image = photo
        partsImg.place(x=50, y=150)
        ...
        heading3 = Label(homepage, text='MotorMoy', bg='black', fg='#ffffff', font=("", 8, "bold"))
        heading3.place(x=55, y=245)

        heading4 = Label(homepage, text='Balon', bg='black', fg='#ffffff', font=("", 8, "bold"))
        heading4.place(x=182, y=245)

        heading5 = Label(homepage, text='Shina', bg='black', fg='#ffffff', font=("", 8, "bold"))
        ...
        heading8 = Label(homepage, text='Fara', bg='black', fg='#ffffff', font=("", 7, "bold"))
